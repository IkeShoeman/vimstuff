...
set nu                          "Ike: show line numbers
set ic                          "Ike: Case during searches
set autoindent                  "Ike: start new line at the same indentation level
syntax enable                   "Ike: syntax highlighting
set cmdheight=1                 "Ike: The commandbar height
"set nobackup                    "Ike: do not keep backup files, it's 70's style cluttering
"set noshowmode			"Ike: VIM powerline setups
...
augroup color_desert256_dev
    au!
    au BufWritePost desert256.vim color desert256
augroup END
...
autocmd FileType c,cpp,h,hpp,scala,txt,ini,json,csv,xml,,ruby,java autocmd BufWritePre <buffer> :%s/\s\+$//e
